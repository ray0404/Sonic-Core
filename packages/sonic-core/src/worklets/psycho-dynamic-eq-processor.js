class PsychoDynamicEQProcessor extends AudioWorkletProcessor {
    ...
    process(inputs, outputs, parameters) {
        ...
        const refDb = parameters.refDb[0];
        const { alloc, free, process_psychodynamic } = this.wasmInstance.exports;
        ...
        for (let ch = 0; ch < input.length; ch++) {
            ...
            try {
                ...
                process_psychodynamic(ptr, frames, sampleRate, intensity, refDb);
...
registerProcessor('psycho-dynamic-eq-processor', PsychoDynamicEQProcessor);
