class SpectralDenoiseProcessor extends AudioWorkletProcessor {
    ...
    process(inputs, outputs) {
        ...
        const { alloc, free, process_spectral_denoise } = this.wasmInstance.exports;
        ...
        for (let ch = 0; ch < input.length; ch++) {
            ...
            try {
                ...
                // process_spectral_denoise(ptr, len, noise_ptr, noise_len)
                // pass 0, 0 for noise to trigger auto-learning
                process_spectral_denoise(ptr, frames, 0, 0);
