...
export class CleanAmp {
  ...
  update(params: EffectParams, time: number) {
      // Clean amps typically have less pre-amp gain available
      const drive = Math.max(0, params.distortion * 0.6); 
